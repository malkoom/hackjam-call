...
public class MiniGame1 : AMiniGame
{
    ...
    IEnumerator ShowWinner()
    {
        ...
        if (P1Score > P2Score)
        {
            ...
            yield return StartCoroutine(ThrowLoser(CarObject2, SumoObject2, Vector3.right));
        }
        // -------------------------
        // P2 GANA
        // -------------------------
        ...
        else if (P2Score > P1Score)
        {
            ...
            yield return StartCoroutine(ThrowLoser(CarObject, SumoObject1, Vector3.left));
        }
        // -------------------------
        // EMPATE
        // -------------------------
    ...
    IEnumerator ThrowLoser(GameObject car, GameObject sumo, Vector3 direction)
    {
        ...
        while (time < ThrowDuration)
        {
            ...
            car.transform.rotation = Quaternion.Euler(0f, 0f, rotation);

            sumo.transform.rotation = Quaternion.Euler(0f, 0f, rotation);

            yield return null;
        }
    }

    IEnumerator PushAnimation(GameObject car, GameObject sumo, Vector3 direction, int player)
    {
        if (player == 1)
        {
            P1Animating = true;
